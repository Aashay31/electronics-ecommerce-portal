        ...
        <section className="w-full max-w-md rounded-3xl border border-slate-200/80 bg-white/90 p-6 shadow-[0_30px_90px_-50px_rgba(15,23,42,0.4)] backdrop-blur sm:p-8">
          ...
          {!isSent ? (
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-700 font-medium">Check your email for a reset link.</p>
            </div>
          )}

          <p className="mt-7 text-center text-sm text-slate-500">
            Remember your password?{" "}
            <Link to="/login" className="font-semibold text-slate-900 transition hover:text-indigo-500">
              Back to Login
            </Link>
          </p>
        </section>
