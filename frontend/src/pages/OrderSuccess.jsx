          ...
          {isLoading ? (
            ...
            <div className="p-8 sm:p-10">
              <div className="grid gap-8 sm:grid-cols-2">
                <div>
                  ...
                  <div className="mt-3 space-y-1 text-sm text-slate-600">
                    <p>
                      <span className="font-medium text-slate-900">Order ID:</span> #{order._id.slice(-8)}
                    </p>
                    <p>
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:justify-center">
                ...
                <Link
                  to="/home"
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-600/30 transition hover:-translate-y-0.5 hover:bg-indigo-700"
                >
