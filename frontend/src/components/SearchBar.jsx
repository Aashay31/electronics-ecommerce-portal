              ...
              <div className="mt-2 grid gap-2">
                {suggestions.map((item) => (
                  <button
                    ...
                    className="flex items-center gap-3 rounded-xl border border-transparent px-2 py-2 text-left text-sm text-slate-700 transition hover:border-slate-200 hover:bg-slate-50"
                  >
                    <img
