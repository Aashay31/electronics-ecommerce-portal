...
function ChatInput({ onSend, disabled }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3 border-t border-white/10 px-4 py-4">
      <div className="rounded-[1.5rem] border border-white/10 bg-black/30 p-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
        <div className="flex items-end gap-2">
          <textarea
            ...
            className="max-h-28 min-h-[44px] flex-1 resize-none bg-transparent px-3 py-2 text-sm text-white outline-none placeholder:text-slate-500"
          />
          <button
            type="button"
